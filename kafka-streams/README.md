...
| -------------------------------------------------------------------------------|-------------------|--------------------|---------------------------------------------------------------------------------------|
| [master](../../../tree/master/kafka-streams)                                   | 0.10.1.0-SNAPSHOT | 3.1.0-SNAPSHOT     | You must manually build the `trunk` version of Apache Kafka and `master` version of Confluent Platform.  See instructions above. |
